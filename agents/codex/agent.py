#!/usr/bin/env python3
"""
Motherbrain Codex Agent

A containerized OpenAI Codex agent that connects to Motherbrain via MCP
...
class MotherbrainAgent:
    def __init__(self):
        ...
        self.name = os.getenv("AGENT_NAME", "codex")
    ...
    def should_respond(self, message: dict) -> bool:
        ...
        # Respond if mentioned with @agent or @codex
        if "@agent" in text.lower() or "@codex" in text.lower():
            return True
    ...
    async def generate_response(self, messages: list) -> str:
        ...
        system_msg = "You are Codex, an AI assistant participating in a chat channel. "
    ...
    async def run(self):
        """Main agent loop."""
        print(f"=== Motherbrain Codex Agent ===")
