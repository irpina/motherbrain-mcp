#!/usr/bin/env python3
"""
Motherbrain Claude Agent

A containerized Claude agent that connects to Motherbrain via MCP
...
class MotherbrainAgent:
    ...
    def should_respond(self, message: dict) -> bool:
        ...
        # Respond if mentioned with @agent or @claude
        if "@agent" in text.lower() or "@claude" in text.lower():
            return True
    ...
    async def generate_response(self, messages: list) -> str:
        ...
        context = "You are Claude, an AI assistant participating in a chat channel. "
        context += "Be helpful, concise, and friendly. Keep responses brief (1-3 sentences).\n\n"
    ...
    async def run(self):
        """Main agent loop."""
        print(f"=== Motherbrain Claude Agent ===")
